            ...
            <div className="holder">
              <div style={{ textAlign: "justify" }}>
                <p>
                  ...
                  CarCoversFactory.co.uk collects, uses, maintains and discloses
                  information collected from users (each, a “User”) of the{" "}
                  <span style={{ textDecoration: "underline" }}>
                    carcoversfactory.co.uk
                  </span>{" "}
                  website (“Site”). This privacy policy applies to the Site and
                  all products and services offered by CarCoversFactory.co.uk.
                </p>
                ...
                <p>
                  CarCoversFactory.co.uk may collect and use Users personal
                ...
                <p>
                  CarCoversFactory.co.uk has the discretion to update this
...
export default PrivacyPolicy20;
