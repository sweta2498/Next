            ...
            <div className="holder">
              <div style={{ textAlign: "justify" }}>
                <p>
                  ...
                  AustraliaCarCovers.com collects, uses, maintains and discloses
                  information collected from users (each, a “User”) of the{" "}
                  <span style={{ textDecoration: "underline" }}>
                    australiacarcovers.com
                  </span>{" "}
                  website (“Site”). This privacy policy applies to the Site and
                  all products and services offered by AustraliaCarCovers.com.
                </p>
                ...
                <p>
                  ...
                  Users visit our site, place an order, fill out a form, and in
                  connection with other activities, services, features or
                  resources we make available on our Site. Users may be asked
                  for, as appropriate, name, email address, mailing address,
                  phone number, credit card information. Users may, however,
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      The Google Analytics features you've implemented based on
                      Display Advertising (e.g., Remarketing, Google Display
                      Network Impression Reporting, the DoubleClick Campaign
                      Manager integration, or Google Analytics Demographics and
                      Interest Reporting).
                    </p>
                  </li>
                  <li>
                    <p>
                      Visitors can opt-out of Google Analytics for Display
                      Advertising and customize Google Display Network ads using
                      the Ads Settings.
                    </p>
                  </li>
                  <li>
                    <p>
                      You use Remarketing with Google Analytics to advertise
                      online.
                    </p>
                  </li>
                  <li>
                    <p>
                      Third-party vendors, including Google, show your ads on
                      sites across the Internet.
                    </p>
                  </li>
                  <li>
                    <p>
                      You and third-party vendors, including Google, use
                      ...
                      someone's past visits to your website.
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      and third-party cookies (such as the DoubleClick cookie)
                      together to report how your ad impressions, other uses of
                      ad services, and interactions with these ad impressions
                      and ad services are related to visits to your site.
                    </p>
                  </li>
                  <li>
                    <p>
                      How you use data from Google's Interest-based advertising
                      or 3rd-party audience data (such as age, gender and
                ...
                <p>
                  AustraliaCarCovers.com may collect and use Users personal
                ...
                <p>
                  AustraliaCarCovers.com has the discretion to update this
                  privacy policy at any time. When we do, we will post a
                  notification on the main page of our Site, revise the updated
...
export default PrivacyPolicy30;
